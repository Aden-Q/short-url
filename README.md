...
Docs are generated by [gin-swagger](https://github.com/swaggo/gin-swagger). To access the docs, go to the following URL after launching the server on localhost.
